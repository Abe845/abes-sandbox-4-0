//Global Variables
color circleblack =#0D0C0C , white=255, black=0, orange=#FF8D00, green=#2F6A09;
color blue=#150B89;
...
void setup() {
  ...
  buttonX[1] = width * 3/7 * 1/3; //Section 1, subsection 1
  buttonY[1] = height * 7/3 * 1/3; //Section 1, subsection 1
  ...
  buttonY[2] = height * 3/6 ; //Section 2, subsection 0: denominator is 3*2, numerator is counted
